...
<!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <a href="{{ route('books.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus-circle fa-sm text-white-50" ></i> Add Book</a>
    </div>
              ...
              <table class="table" id="dataTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('books.edit',$book->id)}}" class="btn btn-success" ><i class="fa fa-edit"></i></a>
